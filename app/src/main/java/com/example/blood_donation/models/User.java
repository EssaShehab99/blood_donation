...
public class User {
    ...
    public User(){}
    // Constructor
    public User(String id, String name, String email,String phone, String bloodType, boolean hasIllnesses, String gender, int age, String city) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phone = phone;
    ...
    public static User fromMap(Map<String, Object> map,String id) {
        ...
        return new User(id, name, email, phone, bloodType, hasIllnesses,  gender, age, city);
    }
